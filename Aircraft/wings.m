...
l_wing1.vx=aircraft.en(8).x-aircraft.en(7).x;
...
l_wing2.o=aircraft.en(8).x;
l_wing2.vx=aircraft.en(9).x-aircraft.en(8).x;
...
l_wing3.o=aircraft.en(9).x;
l_wing3.vx=aircraft.en(10).x-aircraft.en(9).x;
...
r_wing1.vx=aircraft.en(11).x-aircraft.en(7).x;
...
r_wing2.o=aircraft.en(11).x;
r_wing2.vx=aircraft.en(12).x-aircraft.en(11).x;
...
r_wing3.o=aircraft.en(12).x;
r_wing3.vx=aircraft.en(13).x-aircraft.en(12).x;
...
wings_beams=[ wing_support l_wing1 l_wing2 l_wing3 r_wing1 r_wing2 r_wing3];
