...
beam_1.v=[1,0,0]';          % Set the versor of the first beam 
...
beam_2.v=[0,1,0]';                      % Beam 2 is aligned with the global y axis
...
beam_3.v=[0,-1,0]';                     % Beam 3 is aligned with the global -y axis
