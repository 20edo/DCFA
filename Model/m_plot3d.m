...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TO IMPLEMENT
% section that varies along x axis (put a for x=... after if coordinates...
% for now this is a demonstrative function
% Model elements
% for m = 1:size(model.b,2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Parts of the model
...
if options.plot_deformed
    for r = 1:size(model.b,2)
    TR = triangulation(Support(r).Mesh_elements,Support(r).Deformed_nodes.');
    [f,p] = freeBoundary(TR);
